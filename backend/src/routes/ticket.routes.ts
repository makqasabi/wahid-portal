    ...
    const [tickets, total] = await Promise.all([
      prisma.ticket.findMany({
        ...
        include: {
          ...
          category: true,
          client: true,
          submittedBy: { select: { id: true, fullName: true, fullNameEn: true } },
          owner: { select: { id: true, fullName: true, fullNameEn: true } },
          support: { select: { id: true, fullName: true, fullNameEn: true } },
          ownerEntity: true,
          ownerTeam: true,
        },
      }),
  ...
  try {
    const ticket = await prisma.ticket.findUnique({
      ...
      include: {
        ...
        category: true,
        client: true,
        submittedBy: { select: { id: true, fullName: true, fullNameEn: true, entityId: true } },
        owner: { select: { id: true, fullName: true, fullNameEn: true, entityId: true } },
        support: { select: { id: true, fullName: true, fullNameEn: true, entityId: true } },
        ownerEntity: true,
        ownerTeam: true,
        attachments: true,
        auditLogs: {
          ...
          take: 50,
          include: { user: { select: { id: true, fullName: true, fullNameEn: true } } },
        },
      },
    });
    ...
    const comments = await prisma.comment.findMany({
      ...
      include: {
        author: { select: { id: true, fullName: true, fullNameEn: true, entityId: true } },
      },
    });
